...
access(all) fun testFullGameLifecycle() {
    ...
    // ── Step 2: player1 challenges player2 ──────────────────────────────────
    ...
    // gameId=0 (first game, nextGameId starts at 0)
    let gameId: UInt64 = 0

    // ── Step 3: player2 accepts with secret=42 ───────────────────────────────
    ...
    // ── Step 4: player2 reveals colors with same secret ──────────────────────
    ...
    Test.assertEqual(status, 1 as UInt8)
    ...
    // ── Step 6: Verify 16 pieces minted per player ───────────────────────────
    ...
    // ── Step 9: Make move 3 — White d1h5 (Scholar's attack) ──────────────────
    ...
    // Verify move history has 3 entries
    ...
    Test.assertEqual(finalStatus, 4 as UInt8)
